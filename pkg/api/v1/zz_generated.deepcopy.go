...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EgressrulesRulesSpec) DeepCopyInto(out *EgressrulesRulesSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EgressrulesRulesSpec.
func (in *EgressrulesRulesSpec) DeepCopy() *EgressrulesRulesSpec {
	if in == nil {
		return nil
	}
	out := new(EgressrulesRulesSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EgressrulesSpec) DeepCopyInto(out *EgressrulesSpec) {
	*out = *in
	...
	if in.Rules != nil {
		...
		*out = make([]EgressrulesRulesSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
